            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    ...
                    <div class="product__details__pic__slider owl-carousel">
                        ...
                        <img data-imgbigurl="{{asset($product->image_two)}}" src="{{asset($product->image_two)}}" alt="">
                        <img data-imgbigurl="{{asset($product->image_three)}}" src="{{asset($product->image_three)}}" alt="">
