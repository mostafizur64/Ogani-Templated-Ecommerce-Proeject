    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                <div class="hero__categories">
                    ...
                    <ul>
                        ...
                        <li><a href="{{route('category-wises-product-show',$category->id)}}">{{$category->category_name}}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
            <div class="col-lg-9">
                ...
                <div class="hero__item set-bg" data-setbg="/fontend/img/hero/banner.jpg">
...
<section class="featured spad">
    <div class="container">
        ...
        <div class="row featured__filter">
            @foreach($categories as $category)
            @php
            $productss=App\Models\Product::where('category_id',$category->id)->latest()->get();
                    ...
                    <div class="featured__item__pic set-bg" data-setbg="{{asset($product->image_one)}}">
                        <ul class=" featured__item__pic__hover">
                            ...
                            <form action="{{url('add_to_cart',$product->id)}}" method="post">
                                ...
                                <li><button type="sumbit"><i class="fa fa-shopping-cart"></i></button>
                                </li>
                            </form>
                ...
                <div class="latest-product__text">
                    ...
                    <div class="latest-product__slider owl-carousel">
                        <div class="latest-prdouct__slider__item">
                            @foreach($lst_product as $products)
