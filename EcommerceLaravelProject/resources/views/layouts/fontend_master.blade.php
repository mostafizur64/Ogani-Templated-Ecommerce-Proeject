            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="header__top__right">
                        ...
                        @auth
                        <div class="header__top__right__auth">
                            <a href="{{route('home')}}"><i class="fa fa-user"></i> My profile</a>
                        </div>
                        @else
                        <div class="header__top__right__auth">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <nav class="header__menu">
                    <ul>
                        <li class="active"><a href="{{url('/')}}">Home</a></li>
                        <li><a href="{{route('Shop.shop-page')}}">Shop</a></li>
                        <li><a href="#">Pages</a>
                            <ul class="header__menu__dropdown">
                                <li><a href="./shop-details.html">Shop Details</a></li>
                                <li><a href="./shoping-cart.html">Shoping Cart</a></li>
            ...
            <div class="col-lg-3">
                <div class="header__cart">
                    ...
                    $totalQuantity=App\Models\Cart::where('user_ip',request()->ip())->sum('qty');
                    $wishlistqty=App\Models\Wishlist::where('user_id',Auth::id())->get();
                    @endphp
                    <ul>
                        <li><a href="{{url('/wishlist')}}"><i class="fa fa-heart"></i> <span>{{count($wishlistqty)}}</span></a></li>
                        <li><a href="{{url('/cart_page')}}"><i class="fa fa-shopping-bag"></i> <span>{{$totalQuantity}}</span></a></li>
                    </ul>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__about__logo">
                        <a href="{{url('/')}}"><img src="/fontend/img/logo.png" alt=""></a>
                    </div>
                    <ul>
