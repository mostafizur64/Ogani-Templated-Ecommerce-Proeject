...
<body>
    ...
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            <a href="{{route('admin.adminhome')}}" class="sl-menu-link @yield('dashboard')">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                    <span class="menu-item-label">Dashboard</span>
                </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
            <a href="{{route('/')}}" target="__blang" class="sl-menu-link">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{route('add.products')}}" class="nav-link product @yield('add_product')">Add product</a></li>
                <li class="nav-item"><a href="{{route('manage.products')}}" class="nav-link product @yield('manage_product')">Manage Product</a></li>
    ...
    <!-- short-description link are here -->
    ...
    <!-- End short-description link are here -->
    <script>
        $(function() {
            'use strict';
